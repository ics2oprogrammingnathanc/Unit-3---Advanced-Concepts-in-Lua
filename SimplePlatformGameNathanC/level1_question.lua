...
local winSound2 = audio.loadSound( "Sounds/Cheer.m4a")
local correctSoundChannel2
...
local X3 = display.contentWidth*3/7
local Y1 = display.contentHeight*1/2
local Y2 = display.contentHeight*5.5/7
local Y3 = display.contentHeight*5.5/7
...
local function TouchListenerAnswer(touch)
    ...
    if (touch.phase == "ended") then
        correctSoundChannel2 = audio.play(winSound2)
...
function scene:create( event )
    ...
    wrongText3 = display.newText("", X3, Y2, Arial, 75)
